...
urlpatterns = [
    ...
    path('favourites/',
         views.FavouritesListView.as_view(), name='favourites_list'),
    path('favourites/add/<int:post_id>/',
         views.AddToFavouritesView.as_view(), name='add_to_favourites'),
    path('favourites/remove/<int:post_id>/',
         views.RemoveFromFavouritesView.as_view(),
